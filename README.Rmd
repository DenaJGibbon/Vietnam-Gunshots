...
---
title: Gunshot Detection with AlexNet and VGG16 using 'torch for R'
---


This repository contains code for training and evaluating a gunshot detection model using the AlexNet and VGG16 convolutional neural network architecture. The model is trained on the Imagenet dataset and fine-tuned for the specific task of gunshot detection. The code utilizes the 'luz' package in R for deep learning with torch.
...
re-rerun with a few more epochs (perhaps 3)?
Want to add other gunshot training data (?)
It did not work well when using as test data
